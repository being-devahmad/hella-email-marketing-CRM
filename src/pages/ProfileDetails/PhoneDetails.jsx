                                ...
                                <div className='flex justify-between'>
                                    <div className=" w-[60%]  flex flex-col">
                                        ...
                                        {/* DropDown  */}
                                        {
                                            ...
                                            >
                                                <div>
                                                    <input type="text" className='w-full  border-0 border-b-2 border-b-[#d9d9d965] focus:border-none ' placeholder='Search country' />
                                                </div>
                                                {
                                                        ...
                                                        return (
                                                            <>
                                                                ...
                                                                >
                                                                    ...
                                                                    <p className='h-10 py-2 px-3 cursor-pointer'>{country.dial_code}
                                                                    </p>
                                                                </div>
