    ...
    return (
        <>
            <section className='grid grid-cols-1 lg:grid-cols-2'>
                {/* Content Section */}
                <div className={`pt-8 px-4 sm:px-6 lg:px-12 w-full h-screen p-5 overflow-auto`}>
                    ...
                    <div className='pt-5 md:pt-8 poppins-regular'>
                        ...
                        <div className='mt-5'>
                            <form action="">
                                ...
                                {/* DropDown  */}
                                {
                                    toggleCountries ? <div className='flex flex-col h-80 mt-3 w-full overflow-y-scroll rounded-md border border-black/30 bg-transparent py-2 text-sm placeholder:text-gray-600 '>
                                        {
                                            countries.map((country, index) => {
                                                return (
                                                    <>
                                                        <p className='h-10 py-2 px-3 cursor-pointer hover:bg-[#d9d9d965]'
                                                            onClick={() => handleCountrySelect(country.name)} >{country.name}
                                                        </p>
                                                    </>
                                                )
                                            })
